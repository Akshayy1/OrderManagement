              ...
              <Card className="glass p-4 border-white/5 active:scale-[0.99] transition-transform">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="relative">
                    <button
                      onClick={() => setActiveMenuId(activeMenuId === order.id ? null : order.id)}
                      className={`h-10 px-3 rounded-xl border border-border flex items-center justify-center transition-colors ${activeMenuId === order.id ? 'bg-primary text-white border-primary' : 'bg-card text-textMuted'}`}
                    >
                      <MoreHorizontal className="w-4 h-4" />
                    </button>
                  ...
                  <button
                    onClick={() => onDeleteClick(order.id)}
                    className="h-10 px-3 bg-rose-500/10 text-rose-500 rounded-xl hover:bg-rose-500 hover:text-white transition-all flex items-center justify-center"
                  >
